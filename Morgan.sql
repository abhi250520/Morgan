...
--
-- Host: 127.0.0.1    Database: Morgan
-- ------------------------------------------------------
...
CREATE TABLE `order_items` (
  ...
  `shipping_limit_date` varchar(32) DEFAULT NULL,
  `price` decimal(10,0) NOT NULL,
  `freight_value` decimal(10,0) NOT NULL,
  `order_purchase_timestamp` varchar(32) DEFAULT NULL,
...
CREATE TABLE `orders` (
  ...
  `order_purchase_timestamp` varchar(32) DEFAULT NULL,
  `order_approved_at` varchar(32) DEFAULT NULL,
  `order_delivered_carrier_date` varchar(32) DEFAULT NULL,
  `order_delivered_customer_date` varchar(32) DEFAULT NULL,
  `order_estimated_delivery_date` varchar(32) DEFAULT NULL,
...
-- Dump completed on 2020-08-07 17:40:09
